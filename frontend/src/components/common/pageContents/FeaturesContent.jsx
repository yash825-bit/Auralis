      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 py-24">
        ...
        <div className="text-center mb-16">
          ...
          <p className="max-w-3xl mx-auto text-slate-300 text-lg leading-relaxed">
            Discover intelligent features that transform how you connect with opportunities. 
            Powered by AI, designed for humans — experience the future of hiring.
          </p>
          <div className="mt-8 flex items-center justify-center gap-4">
            <button
              onClick={() => navigate("/signup")}
              className="px-6 py-3 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-full hover:from-blue-600 hover:to-cyan-600 transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-cyan-500/25 transform hover:scale-105 active:scale-95 font-medium"
            >
              Get Started
            </button>
            <button
              onClick={() => navigate("/about")}
              className="px-6 py-3 bg-white/10 backdrop-blur-sm text-white rounded-full border border-white/20 hover:bg-white/20 hover:border-white/30 transition-all duration-300 hover:scale-105 active:scale-95 font-medium"
            >
              Learn More
            </button>
          </div>
            ...
            >
              <div className="flex flex-col h-full">
                <div className="flex items-center gap-4 mb-4">
                  <div
                    className={`w-16 h-16 rounded-xl bg-gradient-to-br ${feature.color} flex items-center justify-center text-3xl shadow-lg transition-transform duration-300 hover:scale-110 hover:rotate-3`}
                  >
                    {feature.icon}
                  </div>
                  <h3 className="text-xl font-semibold text-sky-300 transition-colors duration-300">
                    {feature.title}
                  </h3>
                </div>
          ...
          <div className="text-center">
            ...
            <div className="flex items-center justify-center gap-4 flex-wrap">
              <button
                ...
                className="px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-full hover:from-green-600 hover:to-emerald-600 transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-emerald-500/25 transform hover:scale-105 active:scale-95 font-medium"
              >
                Sign Up as Candidate
              </button>
              <button
                onClick={() => navigate("/signup/recruiter")}
                className="px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-full hover:from-purple-600 hover:to-pink-600 transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-pink-500/25 transform hover:scale-105 active:scale-95 font-medium"
              >
